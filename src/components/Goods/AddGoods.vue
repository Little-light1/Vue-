...
<el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="100px" label-position="top">
    <el-tabs tabPosition="left"  v-model="activeIndex" :before-leave = 'beforeleave' @tab-click ="tabClick">
  ...
  <el-checkbox-group v-model="item.attr_vals">
    ...
    v-model="addForm.goods_introduce"
      ></quill-editor>
     <el-button type="primary" style="margin:10px" @click="add">添加商品</el-button>
    </el-tab-pane>
  </el-tabs>
</el-form>
    </el-card>
...
export default {
  ...
  methods: {
    ...
    handelSuccess (response) {
      const picInfo = response.data.tem_path
